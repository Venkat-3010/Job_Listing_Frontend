    ...
    <>
        ...
        <div className={styles.contaier}>
            ...
            <div className={styles.containerBottom}>
                <select onChange={handleSkill} className={styles.inputSelect} name="remote">
                ...
                {skills?.map((skill) => {
                    return (
                        <span className={styles.chip} key={skill}>
                            {skill}
                            <span onClick={() => removeSkill(skill)} className={styles.cross}>
                                X
                            </span>
                        </span>
                    );
                ...
                <div>
                    ...
                    <button className={styles.job} onClick={() => navigate("/job-post")}>
                        +Add Job
                    </button>
                    <button onClick={() => {
                        setSkills([]);
                ...
                <div key={data._id} className={styles.list}>
                    ...
                    <div>
                        ...
                        <div className={styles.btnGroup2}>
                            {token && (
                                <button className={styles.view} onClick={() => {navigate("/job-post", { state: {jobDetails: data, edit: true,},})}}>
                                    Edit Jobs
                                </button>
                            )}
                            <button onClick={() => {
